...
now = datetime.now()
logdir = "/tmp/mnist_convnet_model/" + now.strftime("%Y%m%d-%H%M%S") + "/"
...
def cnn_model_fn(features, labels, mode):
    ...
    # Dense layer 1. Output is N x 1024
    ...
    # Calculate loss if we're not in PREDICT mode (TRAIN and EVAL)
